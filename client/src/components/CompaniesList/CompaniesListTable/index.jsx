...
const CompaniesListTable = ({ history }) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: props => (
        <Fragment>
          <Button color="primary" startIcon={<Search onClick={() => history.push(`companies/${props.row.id}`)} />} />
          <Button color="primary" startIcon={<Edit />} onClick={() => history.push('companies/1/edit')} />
