		...
		<Paper className={paper}>
			...
			<div className={fieldsContainer}>
					...
					<Grid item md={6} xs={12}>
						<FormControl fullWidth size="small">
							...
							<FormHelperText id="reportingBaseHelper">
								Generated reports will be based on the option you will choose
								here.
							</FormHelperText>
						</FormControl>
					</Grid>
				...
				<Grid container spacing={6}>
					<Grid item xs={12} md={6}>
						<FormControl fullWidth size="small">
							<InputLabel htmlFor="nightDifferential">
								Night Differential
							</InputLabel>
				...
				<Grid container spacing={6}>
					...
					<Grid item xs={12} md={3}>
						<FormControl fullWidth size="small">
							<InputLabel htmlFor="overtimeRestDayPay">
				...
				<Grid container spacing={6}>
					...
					<Grid item xs={12} md={3}>
						<FormControl fullWidth size="small">
							<InputLabel htmlFor="regularHolidayPage">
								Regular Holiday Pay
							</InputLabel>
					...
					<Grid item xs={12} md={3}>
						<FormControl fullWidth size="small">
							<InputLabel htmlFor="specialHolidayPay">
								Special Holiday Pay
							</InputLabel>
